                ...
                <div style={{ width: '100%', paddingTop: `${(896 / 985) * 100}%`, position: 'relative' }}>
                  ...
                  {(() => {
                    ...
                    const boxes = [
                      ...
                      [80, 1250, 250, 320],   // b15: 250 x 320
                      [480, 1250, 180, 250],  // b16: 180 x 250
                      [620, 1180, 230, 300],  // b17: 230 x 300
                      [880, 1220, 170, 330],  // b18: 170 x 330

                      // Row 5 (as [x, y, width, height])
                      [-80, 1550, 280, 300],  // b20: 280 x 300
                      [250, 1600, 200, 300],  // Pa_08: 200 x 300
